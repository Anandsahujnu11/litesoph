...
class WorkManagerPage(tk.Frame):
    ...
    def __init__(self, parent, *args, **kwargs):
        ...
        # myTip_Frame2_label_1 = Hovertip(self.Frame2_label_1,'Please upload the geometry file i.e xyz coordinate file using "SELECT" button')
        myTip_Frame2_label_1 = Hovertip(self.Frame2_label_1, tooltipdoc.upload_geometry)


        # tip.bind_widget(self.Frame2_label_1,balloonmsg="Python is an interpreted, high-level and general-purpose programming language")    

        self.Frame2_Button_1 = ttkk.Button(common_frame, text="Select",bootstyle=(INFO, OUTLINE), command=self._get_geometry_file)
        # self.Frame2_Button_1['font'] = myfont()
        self.Frame2_Button_1.grid(column=1, row= 0, padx=10,  pady=10) 
        myTip_Frame2_Button_1 = Hovertip(self.Frame2_Button_1,tooltipdoc.select_geometry)
