from litesoph.simulations.orca.orca_input import orca_create_input
# from litesoph.simulations.orca.orca_read_rt import orca_rt_parser
...
class ORCA:
    ...
    def __init__(self,infile=None, outfile=None, 
                label='orca', directory=".", cmd=None, **kwargs) -> None:
    ...
    def create_input(self):
        ...
        if self.parameters:
            self.template = orca_create_input(**self.parameters) 
    ...
    #     orca_rt_parser(td_out_file, outfile=dipole_file,
    ...
    #     if homo_index:
    #         pop_data = orca_rt_parser(td_out_file, outfile=popl_file,
    ...
    #     else:
    #         orca_rt_parser(td_out_file, outfile=popl_file,
