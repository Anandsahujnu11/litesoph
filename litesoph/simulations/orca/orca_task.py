...
from litesoph.simulations.orca.orca import ORCA
...
class ORCATask(Task):
    ...
    def create_engine(self, param):
        ...
        if self.task_name in self.post_processing_tasks:
            ...
            self.nwchem = ORCA(outfile=str(self.outfile), 
        ...
        self.nwchem = ORCA(infile= self.infile, outfile=self.outfile, 
