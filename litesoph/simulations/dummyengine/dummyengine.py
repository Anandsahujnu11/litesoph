from litesoph.simulations.dummyengine.dummyengine_input import dummyengine_create_input
from litesoph.simulations.nwchem.nwchem_read_rt import dummyengine_rt_parser
...
class dummyengine:
    ...
    def __init__(self,infile=None, outfile=None, 
                label='dummyengine', directory=".", cmd=None, **kwargs) -> None:
    ...
    def create_input(self):
        ...
        if self.parameters:
            self.template = dummyengine_create_input(**self.parameters) 
    ...
    def get_td_dipole(self, dipole_file,
        ...
        dummyengine_rt_parser(td_out_file, outfile=dipole_file,
    ...
    def get_td_moocc(self, popl_file,
        ...
        if homo_index:
            pop_data = dummyengine_rt_parser(td_out_file, outfile=popl_file,
            ...
            dummyengine_rt_parser(td_out_file, outfile=popl_file,
